...
# EXEMPLO 1:
# 
# X1: número de itens produzidos com defeito, em certo dia
# X2: produção média por hora
# Y: tempo, em semanas, decorrido desde o último reparo na máquina
...
SQRes
#
# Intervalo de confian?a de cada par?metro
b0 <- Coe[1,1]
b0 
b1 <- Coe[2,1]
b1
...
t0 = b2/(QMres*c33)^0.5
t0
# Intervalo de Confiança para os parâmteros da regressão
#
...
yo
#
v	<- QMres*t(xo)%*%(P)%*%(xo)     # estimativa da vari?ncia de yo
v
#
